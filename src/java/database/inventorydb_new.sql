...
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`,`company`)
	VALUES ('denise.lee@calgary.ca', true, 'Denise','Lee', 'password', 2, 2);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`,`company`)
	VALUES ('jack.graver@calgary.ca', true, 'Jack','Graver', 'password', 2, 3);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`,`company`)
	VALUES ('sean.chen@calgary.ca', true, 'Sean','Chen', 'password', 2, 1);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`,`company`)
	VALUES ('jones.matthew@calgary.ca', true, 'Jones','Matthew', 'password', 2, 2);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`,`company`)
	VALUES ('ethan.gervais@calgary.ca', false, 'Ethan','Gervais', 'password', 2, 3);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`,`company`)
	VALUES ('naeun.kim@calgary.ca', false, 'Naeun','Kim', 'password', 2, 1);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`,`company`)
	VALUES ('jaeyoung.kim.test@gmail.com', true, 'Jaeyoung','Kim', 'password', 2, 2);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`,`company`)
	VALUES ('aaron.warsylewicz@calgary.ca', false, 'Aaron','Warsylewicz', 'password', 2, 3);
